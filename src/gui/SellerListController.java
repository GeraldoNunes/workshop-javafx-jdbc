...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.initModality(Modality.WINDOW_MODAL); // ENQUANTO NÃO FECHAR ELA NÃO PODERÁ ACESSAR A JANELA
																// ANTERIOR - AULA 379 DEPARTMENTFORM
			dialogStage.showAndWait();
		} catch (IOException e) {
			e.printStackTrace(); // aparecer outras mensagens de erro no consoler, além do de baixo
